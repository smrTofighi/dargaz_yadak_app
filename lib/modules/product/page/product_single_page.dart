        ...
        child: Scaffold(
                          ...
                          children: [
                            Stack(
                              children: [
                                Container(
                                  ...
                                  height:
                                      AppDimens.sizeOfDevice(context).height *
                                          0.35,
                            ...
                            Padding(
                              padding: const EdgeInsets.fromLTRB(
                                  0, 4, AppDimens.high, AppDimens.high),
                              child: Align(
                                alignment: Alignment.centerRight,
                                child: Text(
                                  productController.productModel.value.title!,
                                  style: LightTextStyles.bold22(
                            ...
                            SizedBox(
                              ...
                              child: ListView.builder(
                                itemBuilder: (context, index) => index == 2
                                    ? SizedBox(
                                        width: AppDimens.sizeOfDevice(context)
                                                .width *
                                            0.40,
                                        height: 180,
                                        child: Column(
          ...
          bottomNavigationBar: BtmNavProduct(
            ...
            onPressed: () {
              ...
              String count = '1';
              productController.addProductToBasketList(id, count);
            },
          ),
        ),
      ),
